...
let package = Package(
    ...
    .package(url: "https://github.com/inekipelov/swift-codable-advance.git", from: "0.1.5"),
    .package(url: "https://github.com/inekipelov/swift-collection-advance.git", from: "0.1.11"),
    ],
    targets: [
        .target(
            name: "SwiftAdvance",
